...
with st.expander('Missingness across Passes and Fails'):
  st.write(r"There are 28 features that have over 50% missing values. Of those, some features, like Feature_72 and Feature_73, have a larger difference between passes and fails. That could be significant.
  comparison_df
